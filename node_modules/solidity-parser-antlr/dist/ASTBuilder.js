...
var transformAST = {
  ...
  Expression: function Expression(ctx) {
    ...
    switch (ctx.children.length) {
      ...
      case 3:
	    ...
	    expression_name : toText(ctx.getChild(0)),
      ...
      case 4:
	    ...
	    base_val: toText(ctx.getChild(0)),
 	    index_val: toText(ctx.getChild(2))
          };
        }
        break;
  ...
  VariableDeclarationStatement: function VariableDeclarationStatement(ctx) {
    ...
    if (ctx.variableDeclaration()) {
      ...
      name = toText(ctx.variableDeclaration().getChild(1));
